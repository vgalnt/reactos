...
# Some helper lists (FIXME (CMake new version))
...
function(set_module_type MODULE TYPE)
    ...
    if(NOT ((${TYPE} STREQUAL kernel) OR (${TYPE} STREQUAL kerneldll) OR (${TYPE} STREQUAL kernelmodedriver) OR (${TYPE} STREQUAL wdmdriver)
            OR (${TYPE} STREQUAL nativecui) OR (${TYPE} STREQUAL nativedll) OR (${TYPE} STREQUAL win32cui) OR (${TYPE} STREQUAL win32gui)
            OR (${TYPE} STREQUAL win32dll) OR (${TYPE} STREQUAL win32ocx) OR (${TYPE} STREQUAL cpl) OR (${TYPE} STREQUAL module)))
    ...
    # Set subsystem.
    if((${TYPE} STREQUAL kernel) OR (${TYPE} STREQUAL kerneldll) OR (${TYPE} STREQUAL kernelmodedriver) OR (${TYPE} STREQUAL wdmdriver)
            OR (${TYPE} STREQUAL nativecui) OR (${TYPE} STREQUAL nativedll))
    ...
    if(TYPE STREQUAL kernel)
        ...
        set_target_properties(${MODULE} PROPERTIES ENABLE_EXPORTS TRUE DEFINE_SYMBOL "")
    endif()
