    ...
    _In_ PIRP Irp)
{
    ...
    switch(Request->Function)
    {
        ...
        {
            DPRINT("USBSTOR_Scsi: SRB_FUNCTION_EXECUTE_SCSI\n");
        ...
        {
            DPRINT1("USBSTOR_Scsi: SRB_FUNCTION_RELEASE_DEVICE\n");
        ...
        {
            DPRINT1("USBSTOR_Scsi: SRB_FUNCTION_CLAIM_DEVICE\n");
        ...
        {
            DPRINT1("USBSTOR_Scsi: SRB_FUNCTION_RELEASE_QUEUE\n");
        ...
        {
            DPRINT("USBSTOR_Scsi: SRB_FUNCTION_FLUSH / SRB_FUNCTION_FLUSH_QUEUE / SRB_FUNCTION_SHUTDOWN\n");
